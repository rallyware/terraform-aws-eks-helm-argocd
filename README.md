...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_application_controller_eks_iam_role"></a> [application\_controller\_eks\_iam\_role](#module\_application\_controller\_eks\_iam\_role) | rallyware/eks-iam-role/aws | 0.2.0 |
| <a name="module_server_eks_iam_role"></a> [server\_eks\_iam\_role](#module\_server\_eks\_iam\_role) | rallyware/eks-iam-role/aws | 0.2.0 |
